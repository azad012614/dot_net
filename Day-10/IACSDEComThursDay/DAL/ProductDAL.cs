...
namespace DAL
{
    ...
    {
        public static string conString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\tfladmin\source\repos\IACSDECom\EComWFE\App_Data\ECommDB.mdf;Integrated Security=True";
        ...
        public static List<Product> GetAllUsingDisconnected()
        {
            ...
            IDbConnection con = new SqlConnection(conString);
            string query = "SELECT * FROM flowers,SELECT * FROM customers";
            IDbCommand cmd = new SqlCommand(query, con as SqlConnection);
